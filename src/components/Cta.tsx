  ...
  return (
      <section id="cta" className="py-16 my-24 sm:my-32">
        <div className="container lg:grid lg:grid-cols-2 place-items-center gap-8">
          <div className="lg:col-start-1">
            <h2 className="text-3xl md:text-4xl font-bold">
              Bring Your <span className="text-primary"> Ideas & Concepts </span>
              to Life in One Interface
            </h2>
            <p className="text-muted-foreground text-lg mt-4 mb-8 lg:mb-0">
              Manage your projects seamlessly with a powerful, unified interface.
              Collaborate, organize, and automate – all in one place.
            </p>
          </div>
